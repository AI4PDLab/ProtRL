...
def main():
    ...
    with open(logs_file, "a", newline="") as csvfile:
        fieldnames = ["name", "sequence", "length", "iteration_num", "tm_score", "mmseqs_identity", "plddt", "clean_cosine", "clean_reward", "aln_len"]
        ...
        for line in lines:
            if ">" in line:
                ...
                writer.writerow({
                    ...
                    "aln_len": aln_len # Added for use in reward calc
                })
